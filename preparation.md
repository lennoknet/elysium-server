...
At your fresh debian installation we here used US locale and keyboard, East Coast time zone, set up the admin root with a strong password and a user "control" with another password.
...
After installation is done, find out the IP address to connect via ssh user "control" and enter.
